export const en = {
  ...
  relayNetworkWhitelistDesc: 'Use * for all networks, empty for none, or space-separated network patterns.',
  tldDnsZone: 'Magic DNS Zone',
  foreignRelayBpsLimit: 'Foreign Relay BPS Limit',
  instanceRecvBpsLimit: 'Instance Receive BPS Limit',
  bpsLimitDesc: 'Bytes per second. Leave empty for no limit.',
  ...
  bindDevice: 'Bind to Device',
  proxyForwardBySystem: 'Proxy Forward by System',
  ...
  kcpProxy: 'KCP Proxy',
  disableKcpInput: 'Disable KCP Input',
  quicProxy: 'QUIC Proxy',
  disableQuicInput: 'Disable QUIC Input',
  relayAllPeerRpc: 'Relay All Peer RPC',
  disableRelayData: 'Disable Relay Data',
  disableRelayKcp: 'Disable Relay KCP',
  disableRelayQuic: 'Disable Relay QUIC',
  enableRelayForeignNetworkKcp: 'Relay Foreign Network KCP',
  enableRelayForeignNetworkQuic: 'Relay Foreign Network QUIC',
  magicDns: 'Magic DNS',
  ...
  invalidU64: 'Enter a non-negative integer.',
