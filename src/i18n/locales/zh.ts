export const zh = {
  ...
  relayNetworkWhitelistDesc: '使用 * 表示全部网络，留空表示不允许，多个模式用空格分隔。',
  tldDnsZone: 'Magic DNS 区域',
  foreignRelayBpsLimit: '外部网络中继速率限制',
  instanceRecvBpsLimit: '实例接收速率限制',
  bpsLimitDesc: '单位为字节/秒。留空表示不限制。',
  ...
  enableUpnp: '启用 UPnP',
  kcpProxy: 'KCP 代理',
  disableKcpInput: '禁用 KCP 输入',
  quicProxy: 'QUIC 代理',
  disableQuicInput: '禁用 QUIC 输入',
  relayAllPeerRpc: '中继全部 Peer RPC',
  disableRelayData: '禁用数据中继',
  disableRelayKcp: '禁用 KCP 中继',
  disableRelayQuic: '禁用 QUIC 中继',
  enableRelayForeignNetworkKcp: '中继外部网络 KCP',
  enableRelayForeignNetworkQuic: '中继外部网络 QUIC',
  magicDns: 'Magic DNS',
  privateMode: '私有模式',
